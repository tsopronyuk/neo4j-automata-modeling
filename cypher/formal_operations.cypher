...
// Companion File: formal_operations.cypher
// -------------------------------------------------------------------
...
// -------------------------------------------------------------------
// QUERY 1A: Visual Path Extraction for Arbitrary Words
...
// Target Automaton: 'aut_04' (7-state synthetic NFA)
// ===================================================================

// -------------------------------------------------------------------
// QUERY 2: Global Shortest Non-Empty Accepted Word Search
...
// NOTE: Bound 10 is safe as |Q| = 7, so max simple path length = 6.
// -------------------------------------------------------------------
...
// NOTE: Bound 15 is safe for reachability (|Q| = 8, so max simple path = 7).
// -------------------------------------------------------------------
